...
除了软硬件层面的进步，智驾厂商庞大的用户量也带来了智驾能力的增长飞轮。随着车队规模不断扩大，每天都会产生PB级的真实路况数据，这些数据通过自动标注技术快速回流训练模型，形成了一个自我强化的“数据飞轮”，如小鹏汽车端到端大模型能够做到“每2天一次版本迭代，每2周一次体验升级”。大模型加持下的Robotaxi终于拜托了“越堆越贵，越学越慢”的尴尬困境，驶入了一条快速迭代、低成本扩张的新赛道。
